...
namespace Utilities{
    ...
    class InputUtilities{
        public:
            /// @brief Pedir al usuario un entero positivo en un rango determinado. Se ejecuta un bucle hasta que se ingrese una cantidad válida
...
namespace Menus{
    /// @brief Menu Principal y sus distintas bifurcaciones a otros Submenús/Funciones
    class Menu{
        public:
