...
namespace CompositeData{
    ...
    class Matrix{
        ...
        public:
            ...
            /// @param  Size tamaño que se tomará en cuenta para las operaciones y rellenado
            Matrix(int);

            /// @brief Limpiar la matriz y dejarla llena de ceros
            void zeros();

            /// @brief Llenar el size con valores reales aleatorios en el rango establecido
            void randomizer();

            /// @brief Modificar el Size de lo que se tomará en cuenta para las operaciones
            ...
            Matrix operator * (const Matrix& otro) const; //Sobrecarga del operador multiplicación
    };
}